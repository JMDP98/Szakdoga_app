package com.example.fomenu.ui.advanced_workouts.push_workouts
...
class advanced_push_workouts : Fragment(), OnItemClickListener {

    companion object {
        fun newInstance() = advanced_push_workouts()
    }

    private lateinit var viewModel: AdvancedPushWorkoutsViewModel
    ...
    override fun onCreateView(
        ...
        val adapter = MyRecycleViewAdapter(this,15,"Push Workout") // Replace with your actual adapter
    ...
    override fun onItemClick(position: Int) {
        ...
        intent.putExtra("itemText", "Push A")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(AdvancedPushWorkoutsViewModel::class.java)
