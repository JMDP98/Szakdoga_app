package com.example.fomenu.ui.beginner_workouts.full_Body_Workouts
...
class beginner_full_body_workouts : Fragment(), OnItemClickListener {

    companion object {
        fun newInstance() = beginner_full_body_workouts()
    }

    private lateinit var viewModel: BeginnerFullBodyWorkoutsViewModel
    ...
    override fun onCreateView(
        ...
        val adapter = MyRecycleViewAdapter(this,20,"Full Body Workout") // Replace with your actual adapter
    ...
    override fun onItemClick(position: Int) {
        ...
        intent.putExtra("itemText", "Full Body B")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(BeginnerFullBodyWorkoutsViewModel::class.java)
