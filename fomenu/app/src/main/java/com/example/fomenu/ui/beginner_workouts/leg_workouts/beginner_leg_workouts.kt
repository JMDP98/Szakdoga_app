package com.example.fomenu.ui.beginner_workouts.leg_workouts
...
class beginner_leg_workouts : Fragment(), OnItemClickListener{

    companion object {
        fun newInstance() = beginner_leg_workouts()
    }

    private lateinit var viewModel: BeginnerLegWorkoutsViewModel
    ...
    override fun onCreateView(
        ...
        val adapter = MyRecycleViewAdapter(this,15,"Leg Workout") // Replace with your actual adapter
    ...
    override fun onItemClick(position: Int) {
        ...
        intent.putExtra("itemText", "Leg B")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(BeginnerLegWorkoutsViewModel::class.java)
