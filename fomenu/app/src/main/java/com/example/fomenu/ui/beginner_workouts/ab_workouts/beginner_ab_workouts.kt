package com.example.fomenu.ui.beginner_workouts.ab_workouts
...
class beginner_ab_workouts : Fragment(), OnItemClickListener {

    companion object {
        fun newInstance() = beginner_ab_workouts()
    }

    private lateinit var viewModel: BeginnerAbWorkoutsViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(BeginnerAbWorkoutsViewModel::class.java)
