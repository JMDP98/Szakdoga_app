package com.example.fomenu.ui.advanced_workouts.pull_workouts
...
class advanced_pull_workouts : Fragment(), OnItemClickListener {

    companion object {
        fun newInstance() = advanced_pull_workouts()
    }

    private lateinit var viewModel: AdvancedPullWorkoutsViewModel
    ...
    override fun onCreateView(
        ...
        val adapter = MyRecycleViewAdapter(this,15,"Pull Workout") // Replace with your actual adapter
    ...
    override fun onItemClick(position: Int) {
        ...
        intent.putExtra("itemText", "Pull A")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(AdvancedPullWorkoutsViewModel::class.java)
