package com.example.fomenu.ui.beginner_workouts.push_workouts
...
class beginner_push_workouts : Fragment(), OnItemClickListener {

    companion object {
        fun newInstance() = beginner_push_workouts()
    }

    private lateinit var viewModel: BeginnerPushWorkoutsViewModel
    ...
    override fun onCreateView(
        ...
        val adapter = MyRecycleViewAdapter(this,30,"Push Workout") // Replace with your actual adapter
    ...
    override fun onItemClick(position: Int) {
        ...
        intent.putExtra("itemText", "Push B")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(BeginnerPushWorkoutsViewModel::class.java)
