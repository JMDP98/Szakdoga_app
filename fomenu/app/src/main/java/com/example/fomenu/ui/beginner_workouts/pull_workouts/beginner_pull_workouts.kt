package com.example.fomenu.ui.beginner_workouts.pull_workouts
...
class beginner_pull_workouts : Fragment(), OnItemClickListener {

    companion object {
        fun newInstance() = beginner_pull_workouts()
    }

    private lateinit var viewModel: BeginnerPullWorkoutsViewModel
    ...
    override fun onCreateView(
        ...
        val adapter = MyRecycleViewAdapter(this,35,"Pull Workout") // Replace with your actual adapter
    ...
    override fun onItemClick(position: Int) {
        ...
        intent.putExtra("itemText", "Pull B")

        Log.d("WorkoutLog", "Sending Position: $position")
        Log.d("WorkoutLog", "Sending ItemText: Pull B")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(BeginnerPullWorkoutsViewModel::class.java)
