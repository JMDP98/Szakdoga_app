package com.example.fomenu.ui.advanced_workouts.leg_workouts
...
class advanced_leg_workouts : Fragment(), OnItemClickListener{

    companion object {
        fun newInstance() = advanced_leg_workouts()
    }

    private lateinit var viewModel: AdvancedLegWorkoutsViewModel
    ...
    override fun onItemClick(position: Int) {
        ...
        intent.putExtra("itemText", "Leg A")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(AdvancedLegWorkoutsViewModel::class.java)
